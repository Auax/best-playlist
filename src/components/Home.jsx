    ...
    return (
        <div className="home">
            ...
            <div className="iframe-container w-4/5 md:w-3/5 lg:w-2/4">
                ...
                <iframe src="https://open.spotify.com/embed/playlist/7kIB0YN5eTNIZxgXWt3JSX?utm_source=generator&theme=2" width="100%" height="80" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
            </div>
        </div>
    )
}
